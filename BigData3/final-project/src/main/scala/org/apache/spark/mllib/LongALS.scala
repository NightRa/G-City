...
class LongALS private(
  ...
  /**
    ...
    */
  @Since("0.8.0")
  def run(ratings: RDD[Rating[Long]]): LongMatrixFactorizationModel = {
    ...
    new LongMatrixFactorizationModel(rank, userFactors, prodFactors)
  }

  /**
    * Java-friendly version of [[LongALS.run]].
    */
  @Since("1.3.0")
  def run(ratings: JavaRDD[Rating[Long]]): LongMatrixFactorizationModel = run(ratings.rdd)
}
...
object LongALS {
  ...
  def train(
    ...
    new LongALS(blocks, blocks, rank, iterations, lambda, false, 1.0, seed).run(ratings)
  }
  ...
  def train(
    ...
    new LongALS(blocks, blocks, rank, iterations, lambda, false, 1.0).run(ratings)
  }
  ...
  /**
    ...
    */
  @Since("0.8.0")
  def train(ratings: RDD[Rating[Long]], rank: Int, iterations: Int, lambda: Double)
  : LongMatrixFactorizationModel = {
  ...
  /**
    ...
    */
  @Since("0.8.0")
  def train(ratings: RDD[Rating[Long]], rank: Int, iterations: Int)
  : LongMatrixFactorizationModel = {
  ...
  def trainImplicit(
    ...
    new LongALS(blocks, blocks, rank, iterations, lambda, true, alpha, seed).run(ratings)
  }
  ...
  def trainImplicit(
    ...
    new LongALS(blocks, blocks, rank, iterations, lambda, true, alpha).run(ratings)
  }
  ...
  /**
    ...
    */
  @Since("0.8.1")
  def trainImplicit(ratings: RDD[Rating[Long]], rank: Int, iterations: Int, lambda: Double, alpha: Double)
  : LongMatrixFactorizationModel = {
  ...
  /**
    ...
    */
  @Since("0.8.1")
  def trainImplicit(ratings: RDD[Rating[Long]], rank: Int, iterations: Int)
  : LongMatrixFactorizationModel = {
