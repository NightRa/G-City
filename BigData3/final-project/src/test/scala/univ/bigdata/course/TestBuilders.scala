...
object TestBuilders {
  ...
  def scoredReview(movieId: String, score: Double): MovieReview = {
    new MovieReview(movieId, "user", "user", new Helpfulness(1, 1), score, 7L, "", "")
  }
  ...
  def movieManyReviews(movieId: String, numReviews: Int): Movie = {
    val movie = new MovieReview(movieId, "id", "name", new Helpfulness(1, 2), 0.5, 7L, "", "")
  ...
  def createMovieHelp(movieId: String, user1: String, helpfulness1: Helpfulness, user2: String, helpfulness2: Helpfulness): Movie = {
    val movie1: MovieReview = new MovieReview(movieId, user1, user1, helpfulness1, 0, 7L, "", "")
    val movie2: MovieReview = new MovieReview(movieId, user2, user2, helpfulness2, 0, 7L, "", "")
    val reviews = Vector(movie1, movie2)
    new Movie(movieId, reviews)
  }

  def createMovieSummary(movieName: String, review1: String, review2: String): Movie = {
    val movie1: MovieReview = new MovieReview(movieName, "", "", null, 0, 7L, "", review1)
    val movie2: MovieReview = new MovieReview(movieName, "", "", null, 0, 7L, "", review2)
    val reviews = Vector(movie1, movie2)
